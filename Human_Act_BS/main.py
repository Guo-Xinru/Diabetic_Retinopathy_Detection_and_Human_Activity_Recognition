...
flags.DEFINE_string('Mode', 'Evaluate', 'Specify whether to "Train", "Evaluate" or "Ensemble" a model(s).')
...
def main(argv):
    ...
    # input pipeline to input the dataset
    ...
    if FLAGS.Mode == 'Train':
        ...
        weights_path = os.getcwd() + '/weight/' + FLAGS.weight_path
